...
<link rel="icon" href="./uTheusBanido - Início_files/covis.png">
<html>

        <link rel="stylesheet" href="./uTheusBanido - Início_files/animate.css">
        <link rel="stylesheet" href="./uTheusBanido - Início_files/dark.css">
        <link rel="stylesheet" href="./uTheusBanido - Início_files/core.css">
        <style></style>
...
<head>
    ...
    <body style="">
        <header>
            <nav class="navbar">
                <div>
                    <a class="logo animated fadeInDown" href="" data-animate="fadeInDown" data-delay=".1" style="animation-delay: 0.5s;">
                        <span>uTheusBanido - Dstat</span>
                    </a>
                </div>
                ...
                <ul class="menu animated fadeInDown" data-animate="fadeInDown" data-delay=".1" style="animation-delay: 0.8s">
                    <li><a class="btn grow" href="">Home</a></li>
            </nav>
                    <div align="center">
                    <div class="card animated fadeInUp" data-animate="fadeInUp"">
                        <p>ㅤ</p>
                        <h3>Atenção!</h3>
                        <p>Isso não é um dstat para teste de poder! e sim um dstat para teste de proteção, </p>
                        <p>então seus requests podem ser diminuidos totalmente ao atacar esse dstat</p>
                        <h2>ㅤ</h2>
                    </div>
        </header>
</head>
...
<script id="source" language="javascript" type="text/javascript">
    $(document).ready(function () {
        ...
        let layer7 = new Highcharts.Chart({
            ...
            title: {
                text: "<?php $l7tit = 'Layer 7 ==> ' . 'starspace/dstat.php' . ''; echo $l7tit;?>",
            },
            xAxis: {
                type: "datetime",
